    ...
    return (
        <div className="w-full rounded pb-5 border border-solid border-[#E4E7E9]">
            <div className="w-full py-5 px-6">
                <h1 className="text-lg font-medium leading-6 text-[#191c1f]">Card Totals</h1>
            </div>
            ...
            <div className="px-6">
                <Button width="w-full" type="button">
                    <span className="text-base font-bold leading-[56px] text-white uppercase">Proceed to Checkout</span>
